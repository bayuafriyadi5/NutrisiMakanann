        ...
        <div class="login_page container-fluid h-custom">
            <div class="container">
                <div class="row d-flex justify-content-center align-items-center h-100 mt-5">
                    <div class="col-md-5">
                        <img src="<?= base_url; ?>/img/imagelogin.png" class="img-fluid" alt=" Sample image">
                    </div>
                    <div class="col-md-5">
                        <form action="<?= base_url; ?>/login/prosesLogin" method="post">
                            ...
                            <div class="divider d-flex align-items-center justify-content-center my-4 mb-5">
                                <h4 class="text-center fw-bold  mb-0">Yuk Kita Diet Sekarang</h4>
                            </div>
                            ...
                            <div class="text-center text-lg-start mt-4 pt-2">
                                ...
                                <p class=" small fw-bold mt-2 pt-1 mb-0">Belum punya akun? <a
                                        href="<?= base_url; ?>/daftar" class="link-danger">Yuk daftar</a></p>
