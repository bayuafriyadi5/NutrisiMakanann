                        ...
                        <div class="col-md-4 mb-3 h-100 d-flex align-items-center justify-content-center">
                            <div class="card" style="width: 18rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Fat (lemak) : <?= $row->fat?></p>
                                    <p class="card-text">calories (kalori) : <?= $row->calories?></p>
                                    <p class="card-text">protein (protein) : <?= $row->protein?></p>
                                    <p class="card-text">carbs (karbohidrat) : <?= $row->carbs?></p>
                                    <?php
                                        $tt = $row->id;
                                        $title = $row->title;
                                        ?>
                                    <a class="btn btn-danger" href="<?= base_url; ?>/Nutrisi/yutub/ <?= $title;?>">Buat
                                        Sekarang</a>
                                    <a href="<?= base_url; ?>/Nutrisi/simpan/<?= $tt ?>" class="btn btn-outline-danger"
                                        style="color">Simpan </a>
